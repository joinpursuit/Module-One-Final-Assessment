...
describe('getCountriesSortedByPopulation', () => {
	...
	test('Returns an array of country names sorted by population', () => {
		expect(getCountriesSortedByPopulation(ex1)).toStrictEqual(['China', 'Algeria', 'Denmark', 'Belize'])
		expect(getCountriesSortedByPopulation(ex2)).toStrictEqual(['Russia', 'Egypt', 'New Zealand', 'Argentina'])
	})
})
